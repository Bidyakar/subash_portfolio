    ...
    >
      <div className="max-w-7xl mx-auto overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div
            className={`hidden md:block absolute left-1/2 transform -translate-x-1/2 top-0 bottom-0 w-1 bg-orange/20 transition-all duration-[1200ms] origin-top ${isVisible ? 'scale-y-100' : 'scale-y-0'
              }`}
          />

          {/* Progress Overlay Line - Bright Orange */}
          <div
            className={`hidden md:block absolute left-1/2 transform -translate-x-1/2 top-0 bottom-0 w-1 bg-orange transition-all duration-[1500ms] origin-top ${isVisible ? 'scale-y-100' : 'scale-y-0'
              }`}
          />
            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                >
                  ...
                  <h3 className="text-2xl font-playfair font-bold text-slate-900 mb-2 group-hover:text-orange transition-colors duration-300">
                    {exp.title}
                  </h3>
