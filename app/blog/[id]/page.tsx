...
export default async function BlogPostPage({ params }: Props) {
    ...
    return (
        <main className="min-h-screen bg-white">
            {/* Header Image */}
            <div className="h-[40vh] md:h-[80vh] bg-gray-900 relative">
                {post.imageUrl ? (
                ...
                <div className="absolute bottom-0 left-0 w-full p-6 md:p-12 bg-gradient-to-t from-orange/50 to-transparent">
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <h1 className="text-5xl md:text-7xl font-playfair font-black text-white leading-tight mb-4">
                            {post.title}
                        </h1>
            ...
            {/* Content */}
            <article className="max-w-6xl mx-auto p-6 md:p-12">
